...
import { Plus, Clock, Linkedin, Instagram, Youtube } from 'lucide-react';
...
const scheduledItems = [
  { id: 's1', title: '3 AI repos blowing up on GitHub', pillar: 'breaking-ai-news', platform: 'linkedin', time: '09:00', dayIndex: 0 },
  { id: 's2', title: 'Signal Amplifier: Karpathy\'s latest take', pillar: 'reshared-posts', platform: 'linkedin', time: '12:00', dayIndex: 0 },
  { id: 's3', title: 'GitHub Trends Digest #48', pillar: 'breaking-ai-news', platform: 'linkedin', time: '09:00', dayIndex: 1 },
  { id: 's4', title: 'Hype check: Is Claude 4 worth the upgrade?', pillar: 'hype-detector', platform: 'linkedin', time: '14:00', dayIndex: 2 },
  { id: 's5', title: 'AI Strategy Deep Dive: Build vs Buy', pillar: 'strategy-career', platform: 'linkedin', time: '08:00', dayIndex: 2 },
  { id: 's6', title: 'Instagram carousel: 7 AI tools for 2026', pillar: 'breaking-ai-news', platform: 'instagram', time: '11:00', dayIndex: 3 },
  { id: 's7', title: 'Inside OpenAI\'s latest reorg', pillar: 'inside-the-machine', platform: 'linkedin', time: '10:00', dayIndex: 3 },
  { id: 's8', title: 'Failure Lab: My RAG pipeline disaster', pillar: 'failure-lab', platform: 'linkedin', time: '09:00', dayIndex: 4 },
  { id: 's9', title: 'YouTube: Built an AI agent in 24 hours', pillar: 'live-demos', platform: 'youtube', time: '16:00', dayIndex: 5 },
  { id: 's10', title: 'Weekend reshare roundup', pillar: 'reshared-posts', platform: 'linkedin', time: '10:00', dayIndex: 6 },
];
        ...
        <CardContent>
          <div className="grid grid-cols-7 gap-3">
            {weekDays.map((day, dayIdx) => {
              const dayItems = scheduledItems.filter((i) => i.dayIndex === dayIdx);
              return (
                      ...
                      return (
                        <div
                          ...
                          className={cn(
                            ...
                            pillarColors[item.pillar] || 'border-l-zinc-500 bg-zinc-800/50',
                          )}
                        >
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          {scheduledItems.slice(0, 5).map((item) => {
            const PlatformIcon = platformIcons[item.platform] || Linkedin;
            const day = weekDays[item.dayIndex];
            return (
              <div
                key={item.id}
              ...
              >
                <div className="text-center min-w-[48px]">
                  ...
                  <div className="text-sm font-semibold text-zinc-200">{item.time}</div>
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-1 flex items-center gap-2">
                    <Badge variant="secondary" className="text-[10px]">
                      {item.pillar.split('-').map((w) => w[0].toUpperCase() + w.slice(1)).join(' ')}
                    </Badge>
                  </div>
                </div>
